...
(function() {
  ...
  var config = {
    // General
    player: CKEDITOR.basePath + 'plugins/Media/mediaplayer-5.9/player-viral.swf', 
    ...
    yt: CKEDITOR.basePath + 'plugins/Media/mediaplayer-5.9/yt.swf',
  ...
  CKEDITOR.plugins.add('Media', {
    init: function (editor) {
      CKEDITOR.dialog.add('MediaDialog', function (editor) {
	    ...
	    var html = "<div id='" + config['div_id'] + "_box'>" + dialog.getContentElement('code', 'Code_' + editor.name).getValue() + "</div>";
